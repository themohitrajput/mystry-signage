...
export default function Contact() {
  ...
  return (
    <>
      <SEO
        title="Contact Us"
        description="Get in touch with Mistry Signage for custom signage, neon signs, and branding solutions."
      />
        ...
        <div className="container-page grid grid-cols-1 gap-12 lg:grid-cols-5">
          <div className="lg:col-span-2">
            ...
            <h1 className="font-display text-3xl text-paper sm:text-4xl">
              <span className="tube-underline text-cyan text-glow-cyan">
                Let's Build
              </span>{" "}
              Your Sign
            </h1>
            ...
            <div className="mt-8 space-y-4">
              ...
              {contact.phone && (
                <a
                  ...
                  className="flex items-center gap-3 text-sm text-ash hover:text-paper"
                >
                  <Phone size={18} className="shrink-0 text-amber" />{" "}
                  {contact.phone}
                </a>
              )}
              {contact.email && (
              ...
              {contact.businessHours && (
                <div className="flex items-center gap-3 text-sm text-ash">
                  <Clock size={18} className="shrink-0 text-amber" />{" "}
                  {contact.businessHours}
                </div>
              )}
            </div>
